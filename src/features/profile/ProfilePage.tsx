...
function ProfileForm({ profile }: { profile: UserProfile }) {
  ...
  const update = useAction(
    (values: ProfileValues) => usersApi.updateMe(values),
    t("profileSaved"),
  );
        ...
        >
          <div className={styles.formGrid}>
            <Form.Item
              ...
              name="firstName"
              rules={[{ required: true, message: t("validationFirstName") }]}
            >
            ...
            <Form.Item
              ...
              name="lastName"
              rules={[{ required: true, message: t("validationLastName") }]}
            >
            ...
            <Form.Item
              ...
              name="email"
              rules={[{ required: true, type: "email", message: t("validationEmail") }]}
            >
          ...
          <div className={styles.identity}>
            ...
            <div>
              ...
              <Tag color={profile.role === "ADMIN" ? "purple" : "blue"}>
                {profile.role === "ADMIN" ? t("profileAdmin") : t("profileUser")}
              </Tag>
            </div>
          </div>
          <Descriptions
        ...
        <Panel>
          ...
          >
            ...
            <Form.Item
              ...
              name="newPassword"
              rules={[{ required: true, min: 8, message: t("validationNewPassword") }]}
            >
